...
public class StoryGame3 extends ScreenAdapter {
    ...
    public StoryGame3(SushinGo game){
        this.game = game;
    }
    ...
    public void show() {
        ...
        story1 = new Texture(Gdx.files.internal("Intermedio/3-1.png"));
        story2 = new Texture(Gdx.files.internal("Intermedio/3-2.png"));
        story3 = new Texture(Gdx.files.internal("Intermedio/3-3.png"));
        story4 = new Texture(Gdx.files.internal("Intermedio/3-4.png"));
        story5 = new Texture(Gdx.files.internal("Intermedio/3-5.png"));
