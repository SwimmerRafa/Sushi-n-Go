...
public class End3 extends ScreenAdapter {
    ...
    public void show() {
        ...
        story1 = new Texture(Gdx.files.internal("Intermedio/3-6.png"));
        story2 = new Texture(Gdx.files.internal("Intermedio/3-7.png"));
