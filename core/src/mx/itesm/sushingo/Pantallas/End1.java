...
public class End1 extends ScreenAdapter {
    ...
    public void show() {
        ...
        story1 = new Texture(Gdx.files.internal("Intermedio/1-6.png"));
        story2 = new Texture(Gdx.files.internal("Intermedio/1-7.png"));
