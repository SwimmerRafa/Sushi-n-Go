...
public class StoryGame2 extends ScreenAdapter {
    ...
    public StoryGame2(SushinGo game){
        this.game = game;
    }
    ...
    public void show() {
        ...
        story1 = new Texture(Gdx.files.internal("Intermedio/2-1.png"));
        story2 = new Texture(Gdx.files.internal("Intermedio/2-2.png"));
        story3 = new Texture(Gdx.files.internal("Intermedio/2-3.png"));
        story4 = new Texture(Gdx.files.internal("Intermedio/2-4.png"));
        story5 = new Texture(Gdx.files.internal("Intermedio/2-5.png"));
        story6 = new Texture(Gdx.files.internal("Intermedio/2-6.png"));
        ...
        image6.addAction(sequence(delay(22),fadeIn(3), fadeOut(3), run(new Runnable() {
            @Override
            public void run() {
                game.setScreen(new LoadingScreen2(game));
                dispose();
        ...
        image5.addAction(sequence(delay(18),fadeIn(2), fadeOut(2)));
